...
void solve(int k, int l, int r, int opt_l, int opt_r, vector<long double> &v,
    vector<vector<long double>>&dp, vector<long double> &pref_sum, vector<long double> &pref_sums) {
    int p = (l + r) / 2;
    int opt_mid = opt_l;
